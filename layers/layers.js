...
//ol.proj.get("EPSG:3857").setExtent([1378087.386928, 7483103.897811, 1398189.260477, 7494693.243275]);
var wms_layers = [];
...
lyr_Lokalplanvedtaget_4.set('fieldImages', {'fid': 'Hidden', 'planid': 'TextEdit', 'plantype': 'Hidden', 'plannr': 'TextEdit', 'datovedt': 'Hidden', 'doklink': 'Hidden', 'anvendelse': 'Hidden', });
...
lyr_Folkeskole_17.set('fieldImages', {'Skolenavn': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'Hidden', 'Hjemmeside': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
lyr_Brnehave_18.set('fieldImages', {'Børnehave': 'TextEdit', 'Adresse': 'TextEdit', 'By': 'Hidden', 'Antal bør': 'TextEdit', 'result_num': 'Hidden', 'osm_id': 'Hidden', 'display_na': 'Hidden', 'category': 'Hidden', 'type': 'Hidden', 'latlong': 'Hidden', });
...
lyr_Lokalplanvedtaget_4.set('fieldLabels', {'planid': 'inline label - always visible', 'plannr': 'no label', });
...
lyr_Folkeskole_17.set('fieldLabels', {'Skolenavn': 'no label', 'Adresse': 'no label', 'Hjemmeside': 'no label', });
lyr_Brnehave_18.set('fieldLabels', {'Børnehave': 'no label', 'Adresse': 'no label', 'Antal bør': 'no label', });
